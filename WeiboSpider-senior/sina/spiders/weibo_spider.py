...
class WeiboSpider(RedisSpider):
    ...
    def parse_follow(self, response):
        ...
        for uid in uids:
            ...
            yield Request(self.base_url + '/{}/info'.format(relationships_item["followed_id"]),
                          callback=self.parse,
    ...
    def parse_fans(self, response):
        ...
        for uid in uids:
            ...
            yield relationships_item
            yield Request(self.base_url + '/{}/info'.format(relationships_item["fan_id"]),
                          callback=self.parse,
                          dont_filter=True, priority=1)
